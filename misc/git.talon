...
git show: "git show "
git submit: "git submit --async"
git review update: "git review update"
git review update description: "git review update --update-desc"
git review status: "git review status"
pilar review tool: "pillar-review-tool status"
pilar review tool notify: "pillar-review-tool status -n"
git review create: "git review create --owners-only --no-prompt"
git review decorate: "git review dcommit"
git update: "git commit --amend --no-edit --all"
git update description: "git commit --amend --all"
git apply: "git apply "
